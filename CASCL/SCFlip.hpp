...
public:
    CASCL_Decoder(int CODE_LENGTH_COPY, int CRC_LENGTH_COPY, int INFO_LENGTH_COPY, int LIST_LENGTH_COPY, vector<bool> &EstimatedCRCInfo, vector<bool> isFrozen_COPY, vector<int> BitInverse_COPY, vector<double> ReceivedLLR)
    {
        /*Initialization*/
